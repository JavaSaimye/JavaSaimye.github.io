...
class Creator {
  constructor(name, img, instagram, youtube, tiktok, snapchat, bgcolor, merch) {
    this.name = name;
    this.img = img;
...
//  new Creator('KKid Kay', 'img/Kkidkay.PNG', 'https://instagram.com/ssupremediior?igshid=fcn40son7pn0', '', '', '',"#0000FF"),
  ...
  new Creator('KKid Brii💕', 'img/KKiddiamond.PNG', 'https://instagram.com/_bri_baby_2?igshid=8cl673ywz9b2', '', '', '',"#FFFF00"),
  new Creator('KKid Tatii🥴', 'img/KKidTatii.PNG', 'https://instagram.com/prettyluh.tatii_?igshid=9t5tncyrpco6', '', 'www.tiktok.com/@wh0.tati', 'https://www.snapchat.com/add/tati_lookgood',"#000000"),
